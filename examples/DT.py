...
plt.savefig('initialized_velocity.png')
...
plt.ylabel('Energy')
plt.savefig('energy_spectrum_initialized.png')
...
plt.savefig('velocity_after_simulation.png')
...
plt.savefig('vorticity_after_simulation.png')
