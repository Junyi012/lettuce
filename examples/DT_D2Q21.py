...
plt.savefig('initialized_velocity_D2Q21.png')
...
plt.ylabel('Energy')
plt.savefig('energy_spectrum_initialized_D2Q21.png')
...
plt.savefig('velocity_after_simulation_D2Q21.png')
...
plt.savefig('vorticity_after_simulation_D2Q21.png')
...
plt.legend()
plt.savefig('energy_spectrum_D2Q21.png')