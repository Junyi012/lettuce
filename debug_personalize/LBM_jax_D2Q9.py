...
def main():
    ...
    for iteration_index in tqdm(range(N_ITERATIONS)):
        ...
        if iteration_index % PLOT_EVERY_N_STEPS == 0 and VISUALIZE and iteration_index > SKIP_FIRST_N_ITERATIONS:
            ...
            print(f"dtype of curl: {curl.dtype}")
            ...
            fig.savefig(f"figures/D2Q9_jax/VonKarmon_D2Q9_jax_{iteration_index}.png")
            plt.close()


if __name__ == "__main__":
    import os
    if not os.path.exists("figures/D2Q9_jax"):
        os.makedirs("figures/D2Q9_jax")
